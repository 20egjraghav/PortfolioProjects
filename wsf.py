...
def send_mail():
    ...
    server.ehlo()
    server.login('abc5@gmail.com', 'Type email password')

    subject = "The product you want to buy is below 4000! Now is your chance to buy!"
    body = "This is the moment we have been waiting for. Now is your chance to pick the product of your dreams. Don't miss the opportunity."
